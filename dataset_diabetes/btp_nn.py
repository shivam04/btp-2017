...
class NeuralNetwork():
    def __init__(self):
        ...
        # and mean 0.
        self.synaptic_weights1 = 2 * random.random((45, 5)) - 1
        ...
        for iteration in xrange(number_of_training_iterations):
          ...
          #  print "h1",hidden_l1.shape
           # print "h2",hidden_l2.shape
            #print "to",training_set_outputs.shape
            #print training_set_outputs[:5]
...
if __name__ == "__main__":
   ...
   # print neural_network.synaptic_weights2.shape
    ...
    training_set_outputs = array([y_train]).T
